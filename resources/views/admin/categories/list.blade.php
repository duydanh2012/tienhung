                                        ...
                                        @if ($categories->count() > 0)
                                            @foreach ($categories as $item)
                                                <tr>
                                                    ...
                                                    <td class="cell">
                                                        <a class="btn-sm app-btn-secondary" href="{{ route('categories.edit', $item->id) }}">Sửa</a>
                                                        <button type="button" data-href="{{ route('categories.destroy', $item->id) }}" class="btn-sm app-btn-primary btn-delete" data-toggle="modal" data-target="#exampleModal">Xóa</button>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @else
